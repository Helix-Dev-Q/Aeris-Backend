...
import tokenCreation from "../database/tokens/generate.js";
...
app.post("/auth/v1/oauth/token", async (req, res) => {
  ...
  res.json({
    ...
    organization_id: "Aeris",
    product_id: "prod-fn",
    sandbox_id: "fn",
    deployment_id: "62a9473a2dca46b29ccf17577fcf42d7",
    organization_user_id: "Aeris",
    product_user_id: "Aeris",
...
app.get("/account/api/oauth/verify", verifyToken, (req, res) => {
  ...
  res.json({
    token: `eg1~${token}`,
    session_id: decoded?.jti || decoded?.sub,
    token_type: "bearer",
