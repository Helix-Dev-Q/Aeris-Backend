...
app.post("/fortnite/api/game/v2/chat/*/*/*/pc", (req, res) => {
  let resp = { GlobalChatRooms: [{ roomName: "Aerisglobal" }] };
  res.json(resp);
});
...
app.get("/launcher/api/public/assets/*", async (req, res) => {
  res.json({
    ...
    items: {
      MANIFEST: {
        signature: "Aeris",
        distribution: "https://Aeris.ol.epicgames.com/",
        path: "Builds/Fortnite/Content/CloudDir/Aeris.manifest",
